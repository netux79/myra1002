...
//       CONFIG_INT(g_settings.rewind_buffer_size,          "rewind_buffer_size",         "Rewind Buffer Size",         rewind_buffer_size)     WITH_SCALE(1000000)
   ...
   START_GROUP("Video")
      ...
      START_SUB_GROUP("Scaling")
         ...
         CONFIG_INT(g_extern.console_screen.custom_vp.x,         "custom_viewport_x",       "Custom Viewport X",       0)
         CONFIG_INT(g_extern.console_screen.custom_vp.y,         "custom_viewport_y",       "Custom Viewport Y",       0)
         CONFIG_UINT(g_extern.console_screen.custom_vp.width,    "custom_viewport_width",   "Custom Viewport Width",   0)
         CONFIG_UINT(g_extern.console_screen.custom_vp.height,   "custom_viewport_height",  "Custom Viewport Height",  0)
