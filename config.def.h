...
#define DEFAULT_VIDEO_ROTATION ORIENTATION_AUTO
...
#define DEFAULT_MENU_ROTATION ORIENTATION_NORMAL
#define DEFAULT_MENU_THEME FIRST_THEME
#define DEFAULT_MENU_BILINEAR_FILTER false
