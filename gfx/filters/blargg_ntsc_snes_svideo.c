...
static void *blargg_ntsc_snes_svideo_generic_create(unsigned in_fmt)
{
...
static void blargg_ntsc_snes_svideo_generic_render(void *data,
...
static const struct softfilter_implementation blargg_ntsc_snes_svideo_generic = {
   ...
   blargg_ntsc_snes_svideo_generic_render,
   "Blargg NTSC S-Video",
};
