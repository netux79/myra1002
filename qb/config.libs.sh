...
VARS="MENU ALSA OSS OSS_BSD OSS_LIB AL ROAR JACK COREAUDIO PULSE SDL OPENGL GLES GLES3 VG EGL KMS GBM DRM DYLIB GETOPT_LONG THREADS CG LIBXML2 SDL_IMAGE ZLIB DYNAMIC AVCODEC AVFORMAT AVUTIL SWSCALE FREETYPE XKBCOMMON XVIDEO X11 XEXT XF86VM XINERAMA STDIN_CMD COMMAND SOCKET_LEGACY FBO STRL STRCASESTR MMAP PYTHON VIDEOCORE NEON FLOATHARD FLOATSOFTFP UDEV SCALERS_BUILTIN FILE_LOGGER"
